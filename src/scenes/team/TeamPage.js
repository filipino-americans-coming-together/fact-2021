...
{/*             <Image 
          ...
          <TeamMember
            ...
            imageURL='/img/fact-pack/LorenzoMagnaye.jpg'
          />
          <TeamMember
            name='Myka Padilla'
            position='Co-Coordinator'
            ...
            major=''
            bio=''
            imageURL='/img/fact-pack/MykaPadilla.jpg'
          />
          <TeamMember
            name='Shayna Provine'
            ...
            bio=''
            imageURL='/img/fact-pack/ShaynaProvine.jpg'
          />
          <TeamMember 
            name='Renzo Ledesma'
            ...
            imageURL='/img/fact-pack/RenzoLedesma.jpg'
          />
          <TeamMember 
            ...
            imageURL='/img/fact-pack/MarkWilliamCasco.jpg'
          />
          <TeamMember
            name='Jazmin Aguilar'
            position='Marketing'
            ...
            imageURL='/img/fact-pack/JazminAguilar.jpg'
          />
          <TeamMember
            name='Emily Bautista'
            position='Marketing'
            ...
            imageURL='/img/fact-pack/EmilyBautista.jpg'
          />
          <TeamMember
            ...
            imageURL='/img/fact-pack/NicolasLangtiw.jpg'
          />
          <TeamMember 
            name='Abby Masucol'
            ...
            imageURL='/img/fact-pack/AbbyMasucol.jpg'
          />
          <TeamMember 
            name='Angela Cabrera'
            position='Variety Show Coordinator'
            ...
            imageURL='/img/fact-pack/AngelaCabrera.jpg'
          />
          <TeamMember
            ...
            imageURL='/img/fact-pack/JaninePasquali.jpg'
          />
          <TeamMember 
            name='Francis Fabian'
            position='Hospitality'
            ...
            imageURL='/img/fact-pack/FrancisFabian.jpg'
          />
          <TeamMember 
            ...
            imageURL='/img/fact-pack/MelencioSanidad.jpg'
          />
          <TeamMember 
            name='Brion Nono'
            position='Conference Ambassador'
            ...
            imageURL='/img/fact-pack/BrionNono.jpg'
          />
          <Footer/>
        </Container>
      </Section.Body>
